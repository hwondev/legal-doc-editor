...
- **문서 템플릿**: 소장(대여금)·소장(채무부존재확인)·채무부존재 확인서·답변서·고소장(사기)·내용증명·지급명령 신청서를 `{{변수}}` 빈칸이 들어간 상태로 바로 시작해요
...
| 소장·답변서 부본 통수 | `{{소장 부본 통수}}`·`{{답변서 부본 통수}}` = 상대방 수 | 「민사소송규칙」 제48조제1항, 「민사소송법」 제256조제3항(답변서 부본은 원고에게 송달), [대한법률구조공단 첨부서류 작성방법](https://support.klac.or.kr/front/contents/lawsuit/011.do) |
